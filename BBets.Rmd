...
##  return with 35 students, 2:1 payout
```{r}
urn = 1:365
bank=0
...
for (k in 1:40){
  bank = (BrLw (numClass,odds,counttoDo))
  saveBank[k] = bank
}
print(mean(saveBank))
hist(saveBank)
...
To make the game fair, Brownlow should payout 'r mean(saveBank)'
...
If Brownlow changed his class to 28 then he will lose money.To make the game fair, Brownlow should payout 'r mean(saveBank)' 